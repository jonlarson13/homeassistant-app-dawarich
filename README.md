...
**Current Dawarich version: 1.10.1** ([release notes](https://github.com/Freika/dawarich/releases/tag/1.10.1))
...
```
https://github.com/jonlarson13/homeassistant-app-dawarich
```
...
- [Report an issue](https://github.com/jonlarson13/homeassistant-app-dawarich/issues)
